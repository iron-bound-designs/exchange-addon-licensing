	...
	public function make() {
		...
		switch ( $class ) {
			case 'ITELIC_Key_Generator_Random':
				$generator = new ITELIC_Key_Generator_Random( $options['length'] );
				break;
			case 'ITELIC_Key_Generator_Pattern':
				$generator = new ITELIC_Key_Generator_Pattern( $options['pattern'] );
				break;
			default:
				 ...
				 * @since 1.0
				 *
				 * @param ITELIC_Key_Generator $generator
				 * @param ITELIC_Key_Factory   $this
				 */
