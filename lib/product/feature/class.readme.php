 ...
 * @since  1.0
 */
class ITELIC_Product_Feature_Readme extends IT_Exchange_Product_Feature_Abstract {
	...
	public function __construct() {
		$args = array(
			...
			'description'   => __( "Manage this WordPress Product's README.", ITELIC::SLUG ),
			'metabox_title' => __( "Licensing README", ITELIC::SLUG ),
	...
	function print_metabox( $post ) {
		...
		<div class="itelic-readme-settings<?php echo esc_attr( $hidden ); ?>">
			...
			<label for="itelic-readme-tested"><?php _e( "Tested Up To", ITELIC::SLUG ); ?></label>
			<input type="text" id="itelic-readme-tested" name="itelic_readme[tested]" value="<?php echo esc_attr( $data['tested'] ); ?>">

			<p class="description"><?php _e( "Latest version of WordPress your product has been tested with.", ITELIC::SLUG ); ?></p>

			<label for="itelic-readme-requires"><?php _e( "Minimum Required Version", ITELIC::SLUG ); ?></label>
			<input type="text" id="itelic-readme-requires" name="itelic_readme[requires]" value="<?php echo esc_attr( $data['requires'] ); ?>">

			<p class="description"><?php _e( "Minimum required WordPress version to use your product.", ITELIC::SLUG ); ?></p>

			<label for="itelic-readme-author"><?php _e( "Contributors", ITELIC::SLUG ); ?></label>
			<input type="text" id="itelic-readme-author" name="itelic_readme[author]" value="<?php echo esc_attr( $data['author'] ); ?>">

			<p class="description"><?php _e( "Comma-separated list of WordPress.org usernames.", ITELIC::SLUG ); ?></p>

			<label for="itelic-readme-last-updated"><?php _e( "Last Updated", ITELIC::SLUG ); ?></label>
			...
			<p class="description"><?php _e( "Date of the last product update.", ITELIC::SLUG ); ?></p>

			<label for="itelic-readme-banner-low"><?php _e( "Lo-res Plugin Banner", ITELIC::SLUG ); ?></label>
			<input type="url" id="itelic-readme-banner-low" name="itelic_readme[banner_low]" value="<?php echo esc_attr( esc_url( $data['banner_low'] ) ); ?>">

			<p class="description"><?php _e( "Link to banner. 772x250 pixels, either a <b>png</b> or <b>jpg</b>.", ITELIC::SLUG ); ?></p>

			<label for="itelic-readme-banner-high"><?php _e( "Hi-res Plugin Banner", ITELIC::SLUG ); ?></label>
			...
			<p class="description"><?php _e( "Link to banner. 1544x500 pixels, either a <b>png</b> or <b>jpg</b>.", ITELIC::SLUG ); ?></p>
		</div>
	<?php
	}
