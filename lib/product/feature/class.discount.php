...
/**
 * Class ITELIC_Product_Feature_Discount
 */
class ITELIC_Product_Feature_Discount extends IT_Exchange_Product_Feature_Abstract {
	...
	public function __construct() {
		$args = array(
			...
			'description'   => __( "Manage renewal discounts.", ITELIC::SLUG ),
			'metabox_title' => __( "Licensing Discount", ITELIC::SLUG ),
	...
	function print_metabox( $post ) {
		...
		$types = array( 'flat' => __( "Flat", ITELIC::SLUG ), 'percent' => __( "Percent", ITELIC::SLUG ) );
		?>
		...
		<div class="itelic-discount-settings<?php echo esc_attr( $hidden ); ?>">
			...
			<label for="itelic-discount-type"><?php _e( "Discount Type", ITELIC::SLUG ); ?></label>
			...
			<label for="itelic-discount-amount"><?php _e( "Discount Amount", ITELIC::SLUG ); ?></label>
			...
			<label for="itelic-discount-expiry"><?php _e( "Valid Until", ITELIC::SLUG ); ?></label>
